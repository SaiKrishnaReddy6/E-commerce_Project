...
// Connect to MongoDB
mongoose.connect('mongodb+srv://saikrishnareddychennuru:Sai@atlas1@cluster0.q1omwoh.mongodb.net/?retryWrites=true&w=majority', { useNewUrlParser: true,
    useUnifiedTopology: true})
  .then(() => console.log('MongoDB connected'))
  .catch((err) => console.log(err));

// Connect to MySQL
const sequelize = new Sequelize('ecommerce', 'root', 'Sai@mysql1', {
  host: 'localhost',
  dialect: 'mysql'
});
